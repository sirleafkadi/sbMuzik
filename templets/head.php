    ...
    <!-- IOS Touch Icons -->
    <link rel="apple-touch-icon" href="dist/assets/images/logos/touch-icon-iphone.png">
    <link rel="apple-touch-icon" sizes="152x152" href="dist/assets/images/logos/touch-icon-ipad.png">
    <link rel="apple-touch-icon" sizes="180x180" href="dist/assets/images/logos/touch-icon-iphone-retina.png">
    <link rel="apple-touch-icon" sizes="167x167" href="dist/assets/images/logos/touch-icon-ipad-retina.png">
