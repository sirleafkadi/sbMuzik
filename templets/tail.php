...
if(id==0){url="app/ajax_request.php"} else{ url="app/ajax_request.php?cat_id="+id; }
...
ajax.onreadystatechange=function(){
  if(this.readyState==4 && this.status==200){
   ...
   $("#totals").html(this.responseText);
   total =$("#totals").children().length;
